...
-- Volcando datos para la tabla noticies.captcha: ~21 rows (aproximadamente)
/*!40000 ALTER TABLE `captcha` DISABLE KEYS */;
INSERT INTO `captcha` (`captcha_id`, `captcha_time`, `ip_address`, `word`) VALUES
	(64, 1620238351, '::1', 'qnphjtbh'),
	(65, 1620238353, '::1', 'agqbdilk'),
	(66, 1620238354, '::1', 'tcihmndb'),
	(67, 1620238383, '::1', 'eujanvud'),
	(68, 1620238395, '::1', 'jnklbccz'),
	(69, 1620238406, '::1', 'yuqazzso'),
	(70, 1620238406, '::1', 'beizdyyl'),
	(71, 1620238406, '::1', 'cosdvngo'),
	(72, 1620238430, '::1', 'thjqqhhh'),
	(73, 1620238430, '::1', 'rfitknxq'),
	(74, 1620238442, '::1', 'sfkdhuvl'),
	(75, 1620238442, '::1', 'pdqitjaz'),
	(76, 1620238442, '::1', 'nfitvaqc'),
	(77, 1620238450, '::1', 'wftnndxv'),
	(78, 1620238450, '::1', 'wkgtakgr'),
	(79, 1620238451, '::1', 'fbmwpdbq'),
	(80, 1620238452, '::1', 'hcwlhooe'),
	(81, 1620238478, '::1', 'jrynyljj'),
	(82, 1620238478, '::1', 'mmdhuxmc'),
	(83, 1620238478, '::1', 'kpywxadf'),
	(84, 1620238493, '::1', 'etlqwbiv'),
	(85, 1620238494, '::1', 'otebdoul'),
	(86, 1620238494, '::1', 'imzxwvmu'),
	(87, 1620309580, '::1', 'jfeaubqd'),
	(88, 1620310660, '::1', 'wkwmbmcd');
...
-- Volcando datos para la tabla noticies.login_attempts: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla noticies.users: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
	(1, '127.0.0.1', 'administrator', '$2y$10$.gQBTIc.W1pmHeSVzYB6pudj2aO.V6bHmFGmIL1ngdxoMLokCUhLC', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1620309424, 1, 'Admin', 'istrator', 'ADMIN', '0');
...
-- Volcando datos para la tabla noticies.users_groups: ~3 rows (aproximadamente)
